...
if source_option == "Use Live Camera":
    camera_input = st.camera_input("Position your face clearly in the center box boundary","💡 For accurate AI analysis: Sit facing a bright light source and ensure your background is plain.")
